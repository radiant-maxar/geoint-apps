...
# geoint-deps support files are used because data downloads now require a custom user agent:
...
%if %{with tests}
Source4:        https://geoint-deps.s3.amazonaws.com/support-files/monaco-latest.osm.pbf
%endif
